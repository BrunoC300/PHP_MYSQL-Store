...
//Detalhe Produto
$qDetalheProd = "SELECT * FROM produtos$lang where referencia='" . $_GET['product'] . "'";
$rsDetalheProd = $csogani->query($qDetalheProd);

if ($rsDetalheProd === FALSE) {
  die("Erro no SQL: " . $qDetalheProd . " Error: " . $csogani->error);
}

$rsDetalheProd->data_seek(0);
$row_rsDetalheProd = $rsDetalheProd->fetch_assoc();
            ...
            <ul>
              <?php while ($row_rsCategorias = $rsCategorias->fetch_assoc()) {
                if ($row_rsCategorias['menu'] == true) { ?>
                  <li>
                    <a href="shop-grid.php?id=<?= $row_rsCategorias['id'] ?>"><?= $row_rsCategorias['categoria'] ?></a>
                  </li>
              <?php }
              } ?>
            </ul>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6">
          <div class="product__details__pic">
            <div class="product__details__pic__item">
              <img class="product__details__pic__item--large" src="img/product/<?= $row_rsDetalheProd['imagem'] ?>" alt="">
            </div>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="product__details__text">
            <h3><?= $row_rsDetalheProd['designacao'] ?></h3>
            ...
            <div class="product__details__price"><?= $row_rsDetalheProd['preco'] ?> €</div>
            <p><?= $row_rsDetalheProd['info'] ?></p>
